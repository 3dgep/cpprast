...
template<typename E>
typename std::enable_if<enable_bitmask_operators<E>::enable, bool>::type operator==( std::underlying_type_t<E> lhs, E rhs )
{
    typedef typename std::underlying_type<E>::type underlying;
...
template<typename E>
typename std::enable_if<enable_bitmask_operators<E>::enable, bool>::type operator==( E lhs, std::underlying_type_t<E> rhs )
{
    typedef typename std::underlying_type<E>::type underlying;
