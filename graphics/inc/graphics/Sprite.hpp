...
public:
    ...
    /// <summary>
    /// Constructs a Sprite from an image file with an optional blend mode.
    /// </summary>
    /// <param name="fileName">The path to the image file to load for the sprite.</param>
    /// <param name="blendMode">The blend mode to use when rendering the sprite. Defaults to a default BlendMode.</param>
    explicit Sprite( const std::filesystem::path& fileName, const BlendMode& blendMode = BlendMode {} );

    /// <summary>
    /// Constructs a Sprite from an image file with a specified rectangular region and blend mode.
    /// </summary>
    /// <param name="fileName">The path to the image file to load.</param>
    /// <param name="rect">The rectangular region defining the sprite's bounds.</param>
    /// <param name="blendMode">The blend mode to use when rendering the sprite. Defaults to a default-constructed BlendMode.</param>
